...
|---|---|---|---|
| AUD-203 | AUD-117 case E (ResolveDisputeTimeout substitution) intentionally untested per `tests/cpi-failures.test.ts:1255-1270`; defense-in-depth claim is asymmetric — only 3 of 4 contexts have negative-path proof. | `tests/cpi-failures.test.ts:1255` | **Closed — `<sha-pending>`** [^aud203] |
