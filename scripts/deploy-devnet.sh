...
VAULT_PROGRAM_ID="AuZc1rQBxT5Ekz84NJ7DCMuHGwuvcSFbgufvmRcuh338"
REGISTRY_PROGRAM_ID="8t5oSA3xrLt9rMmM7QZBFWFDgBu8qvWsrUyXFYwPYWmV"
SETTLEMENT_PROGRAM_ID="2uSDxQtYLU4uSeZtA1ueJx7xg4PDYpEbkxM957T5UUm4"
...
echo "  3. Run smoke test: cd mcp-server && npx ts-mocha -p tsconfig.test.json test/mcp-handlers.test.ts"
