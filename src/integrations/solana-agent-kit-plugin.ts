/** AEAP Solana Agent Kit Plugin - wraps MCP tools as SAK-compatible tools */
...
export const aeapTools: SakTool[] = [
  t("aeap_create_vault", "Create agent vault with spending policies", [
  ...
  t("aeap_get_vault_info", "Get vault balance and policies", [i("vaultAddress", "string", "Vault key")], "get_vault_info"),
  t("aeap_vault_transfer", "Transfer SOL from vault", [
    i("recipientAddress", "string", "Recipient key", true), i("amountSol", "number", "SOL amount", true),
  ], "vault_transfer"),
  t("aeap_update_vault_policy", "Update vault spending limits", [
    i("dailyLimitSol", "number", "Daily limit", true), i("perTxLimitSol", "number", "Per-tx limit", true),
    i("maxTxsPerHour", "number", "Rate limit", true),
  ], "update_vault_policy"),
  t("aeap_pause_vault", "Pause vault", [], "pause_vault"),
  t("aeap_resume_vault", "Resume vault", [], "resume_vault"),
  t("aeap_manage_allowlist", "Manage vault allowlist", [
    i("action", "string", "add_token|remove_token|add_program|remove_program", true),
    i("address", "string", "Token/program address", true),
  ], "manage_allowlist"),
  t("aeap_register_agent", "Register agent in registry", [
  ...
  t("aeap_get_agent_profile", "Get agent profile", [i("agentAddress", "string", "Agent key")], "get_agent_profile"),
  t("aeap_discover_agents", "Search for agents", [
  ...
  t("aeap_accept_task", "Accept task", [i("escrowAddress", "string", "Escrow key", true)], "accept_task"),
  t("aeap_submit_milestone", "Submit milestone", [
    i("escrowAddress", "string", "Escrow key", true), i("milestoneIndex", "number", "Index", true),
  ], "submit_milestone"),
  t("aeap_approve_milestone", "Approve milestone", [
    i("escrowAddress", "string", "Escrow key", true), i("milestoneIndex", "number", "Index", true),
    i("providerTokenAccount", "string", "Provider token acct", true),
  ], "approve_milestone"),
  t("aeap_reject_milestone", "Reject milestone", [
    i("escrowAddress", "string", "Escrow key", true), i("milestoneIndex", "number", "Index", true),
  ], "reject_milestone"),
  t("aeap_get_escrow_status", "Get escrow status", [i("escrowAddress", "string", "Escrow key", true)], "get_escrow_status"),
  t("aeap_cancel_escrow", "Cancel escrow", [i("escrowAddress", "string", "Escrow key", true)], "cancel_escrow"),
  t("aeap_raise_dispute", "Raise dispute", [i("escrowAddress", "string", "Escrow key", true)], "raise_dispute"),
  t("aeap_resolve_dispute", "Resolve dispute", [
