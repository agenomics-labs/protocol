...
///
/// ADR-040: Account space is explicitly calculated as 1413 bytes
...
///  + 8 bytes for ADR-097 registration_nonce: u64 = 1413).
///
...
impl AgentProfile {
    /// ADR-040 / ADR-097 explicit space calc. Do NOT drift from the `space = ...`
