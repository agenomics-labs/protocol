...
export const MCP_TOOLS = [
  ...
  { name: "create_delegation_grant", program: "vault" },
  { name: "revoke_delegation_grant", program: "vault" },
  { name: "update_delegation_grant", program: "vault" },
  { name: "execute_grant_transfer", program: "vault" },
  { name: "execute_grant_token_transfer", program: "vault" },
  { name: "get_delegation_grant", program: "vault" },
  { name: "list_delegation_grants_for_vault", program: "vault" },
